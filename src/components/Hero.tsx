  ...
  return <section className="relative min-h-[90vh] overflow-hidden">
      ...
      <div className="container relative mx-auto flex min-h-[90vh] flex-col items-center justify-center px-4 py-20 md:px-6">
        ...
        <div className="mb-8 flex items-center gap-3 animate-fade-in">
          ...
          <span className="text-4xl font-black text-foreground md:text-5xl">
        ...
        <Button size="lg" className="group h-14 px-8 text-lg font-bold shadow-xl hover:shadow-2xl transition-all bg-accent text-accent-foreground hover:bg-accent/90" onClick={onStartQuiz}>
